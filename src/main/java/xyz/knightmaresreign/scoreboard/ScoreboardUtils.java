package xyz.knightmaresreign.scoreboard;
...
public class ScoreboardUtils {
	...
	public void createScore(String text) {
		lines.put(text, KnightmaresReign.getInstance().toColour(text));
	}
	
	public void createScore(String id, String text) {
		lines.put(id, KnightmaresReign.getInstance().toColour(text));
	}
	
	public void setSuffix(String id, String suffix) {
		sb.getTeam(id).suffix(KnightmaresReign.getInstance().toComponent(suffix));
	}
	
	public void finalizeScoreboard(Player player) {
		sb = Bukkit.getScoreboardManager().getNewScoreboard();
		obj = sb.registerNewObjective(id, Criteria.DUMMY, KnightmaresReign.getInstance().toComponent(displayName), RenderType.INTEGER);
	...
	public void setDisplayName(String display) {
		obj.displayName(KnightmaresReign.getInstance().toComponent(display));
	}
